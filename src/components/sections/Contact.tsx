...
export function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Dynamically importing the heavy @emailjs/browser SDK only when the user submits
      // removes it from the initial JS bundle, significantly improving page load time.
