...
const B1_SQ_VAL = Math.pow(MAX_DISTANCE * (1 / 6), 2);
const B2_SQ_VAL = Math.pow(MAX_DISTANCE * (2 / 6), 2);
const B3_SQ_VAL = Math.pow(MAX_DISTANCE * (3 / 6), 2);
const B4_SQ_VAL = Math.pow(MAX_DISTANCE * (4 / 6), 2);
const B5_SQ_VAL = Math.pow(MAX_DISTANCE * (5 / 6), 2);
