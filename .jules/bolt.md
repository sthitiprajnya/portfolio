...
## 2026-05-31 - Dynamic imports of heavy SDKs
...
**Action:** Always use dynamic imports for heavy third-party SDKs that are not immediately required on the initial page load, especially within event handlers like form submissions.
