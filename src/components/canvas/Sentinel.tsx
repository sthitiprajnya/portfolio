...
export default function Sentinel() {
  ...
  useEffect(() => {
    ...
    const updateSprite = (
      ...
      if (
        Math.abs(fCR - lastRenderedColor.r) < 1 &&
        Math.abs(fCG - lastRenderedColor.g) < 1 &&
        Math.abs(fCB - lastRenderedColor.b) < 1 &&
        Math.abs(fCA - lastRenderedColor.a) < 0.01
      ) return;

      lastRenderedColor = { r: fCR, g: fCG, b: fCB, a: fCA };
