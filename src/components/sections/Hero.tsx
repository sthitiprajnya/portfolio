...
// BOLT: Hoist numeric stat parsing to module level to avoid redundant regex/parseInt on every render
const PARSED_HERO_STATS = HERO_STATS.map(stat => ({
  ...stat,
