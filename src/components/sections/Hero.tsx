    ...
    >
      ...
      <div className="relative z-10 w-full max-w-[900px] px-6 flex flex-col items-center text-center flex-1 justify-center">
        ...
        >
          ...
          <CyberButton color="amber" onClick={() => setShowMethodology(true)} aria-haspopup="dialog" title="View methodology">VIEW_METHODOLOGY</CyberButton>
          ...
          >
            ...
            >
              <div className="flex items-center justify-between mb-6 pb-4 border-b border-border">
                <span id="methodology-title" className="font-mono text-amber text-lg font-bold tracking-widest flex items-center gap-3">
          ...
          >
            ...
            >
              <div className="flex items-center justify-between mb-4 pb-2 border-b border-border">
                <span id="intel-title" className="font-mono text-cyan text-sm font-bold tracking-widest flex items-center gap-2">
