...
## 2026-07-16 - Dynamic Imports for Heavy SDKs
...
**Action:** When integrating heavy SDKs that are only used in specific user interactions (like form submissions), lazily load them at the call site to reduce the initial JavaScript bundle size.
