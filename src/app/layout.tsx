                    ...
                    createHTML: (s) => {
                      if (typeof s === 'string') {
                        ...
                        if (
                          ...
                          /on[a-z]+\\s*[=>\\s]/i.test(lower) ||
                          /(formaction|srcdoc|srcset|style|action|background|bgcolor|xlink:href|autofocus|contenteditable|ping)\\s*[=>\\s]/i.test(lower)
                        ) {
                          ...
                          return s
                            ...
                            .replace(/on[a-z]+\\s*[=>\\s]/gi, (match) => 'blocked-' + match)
                            .replace(/(formaction|srcdoc|srcset|style|action|background|bgcolor|xlink:href|autofocus|contenteditable|ping)\\s*[=>\\s]/gi, (match) => 'blocked-' + match);
                        }
                      }
                      return s;
                    },
