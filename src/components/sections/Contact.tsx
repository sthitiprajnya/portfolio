          ...
          <ScrollReveal variants={fadeSlideUp} className="space-y-8 flex flex-col justify-between h-full">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <a
                ...
                target="_blank" rel="noopener noreferrer"
                className="group flex flex-col items-center justify-center p-6 rounded-card glass hover:border-white hover:shadow-[var(--glow-white-sm)] hover:-translate-y-1 transition-all outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-black"
              >
